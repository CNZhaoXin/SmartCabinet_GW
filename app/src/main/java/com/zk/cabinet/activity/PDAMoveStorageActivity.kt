 ...
 * PDA-移库
 */
class PDAMoveStorageActivity : TimeOffAppCompatActivity(), View.OnClickListener {
    ...
    companion object {
        fun newIntent(packageContext: Context?): Intent {
            return Intent(packageContext, PDAMoveStorageActivity::class.java)
        }
    }
    ...
    private class MyHandler(activity: PDAMoveStorageActivity) : Handler() {
