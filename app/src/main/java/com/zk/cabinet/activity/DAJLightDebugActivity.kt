...
import com.zk.cabinet.databinding.ActivityLightDebugBinding
 ...
 * 档案组架-灯控调试界面
 */
class DAJLightDebugActivity : TimeOffAppCompatActivity(), View.OnClickListener {
    private lateinit var mBinding: ActivityLightDebugBinding

    companion object {
        fun newIntent(packageContext: Context?): Intent {
            return Intent(packageContext, DAJLightDebugActivity::class.java)
        }
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mBinding = DataBindingUtil.setContentView(this, R.layout.activity_light_debug)
