...
/**
 * ClearAndSeePwdEditText
 * 1.可清除
 * 2.可显示隐藏密码的
 * Created by 赵鑫 on 2020/8/4.
 */
public class ClearAndSeePwdEditText extends AppCompatEditText implements View.OnFocusChangeListener {
    ...
    public ClearAndSeePwdEditText(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        this.context = context;
        init();
    }

    public ClearAndSeePwdEditText(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.context = context;
        init();
    }

    public ClearAndSeePwdEditText(Context context) {
        super(context);
        this.context = context;
        init();
    }
    ...
    private void init() {
        ...
        clearButShow = ((BitmapDrawable) getResources().getDrawable(R.mipmap.ic_delete)).getBitmap();
        passwordEyeInvisible = ((BitmapDrawable) getResources().getDrawable(R.mipmap.ic_show_password)).getBitmap();
        passwordEyeVisible = ((BitmapDrawable) getResources().getDrawable(R.mipmap.ic_hide_password)).getBitmap();
