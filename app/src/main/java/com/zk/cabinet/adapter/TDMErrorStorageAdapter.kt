...
class TDMErrorStorageAdapter(
    context: Context,
    list: List<ResultMQTTMessageErrorOutStorage.Data.ArchivesList>
) :
    BaseAdapter() {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        ...
        if (view == null) {
            view = mLayoutInflater.inflate(R.layout.adapter_tdm_error_out_storage, null)
            viewHolder = TDMErrorStorageAdapter.ViewHolder(
    ...
    fun setList(list: List<ResultMQTTMessageErrorOutStorage.Data.ArchivesList>) {
        mList = list
    }
}