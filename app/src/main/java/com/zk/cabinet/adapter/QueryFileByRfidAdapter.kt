...
class QueryFileByRfidAdapter(
    context: Context,
    searchFileList: ArrayList<FileDetailsData>
) :
    BaseAdapter() {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        ...
        if (view == null) {
            ...
            viewHolder = QueryFileByRfidAdapter.ViewHolder(
        ...
        // 待入库0,在库10,借阅审批中50,待借阅100,待归还200,异常9000
    ...
    fun setList(searchFileList: ArrayList<FileDetailsData>) {
