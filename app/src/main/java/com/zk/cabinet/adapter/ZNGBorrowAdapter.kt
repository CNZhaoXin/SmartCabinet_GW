...
class ZNGBorrowAdapter(
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        ...
        if (view == null) {
            view = mLayoutInflater.inflate(R.layout.adapter_zng_borrow, null)
            viewHolder = ZNGBorrowAdapter.ViewHolder(
